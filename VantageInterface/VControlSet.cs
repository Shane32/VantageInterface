...
namespace VantageInterface
{
    public class VControlSet
    {
        ...
        {
            _control.WriteLine($"LED {vid} {red} {green} {blue} {redBlink} {greenBlink} {blueBlink} {blinkRate.ToString().ToLower()}");
        }
        ...
        {
            return _control.WriteLineAsync($"LED {vid} {red} {green} {blue} {redBlink} {greenBlink} {blueBlink} {blinkRate.ToString().ToLower()}");
        }
